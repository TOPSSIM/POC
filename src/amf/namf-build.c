        ...
        amf_ue_t *amf_ue, void *data)
{
    ...
    ogs_info("[DBG][N14][BUILD][UEContextTransfer] UE-CTX-ID[%s] access_type[%d] reason[%d]",
            ue_context_id, UeContextTransferReqData.access_type,
            UeContextTransferReqData.reason);
        ...
        amf_ue_t *amf_ue, void *data)
{
    ...
    ogs_info("[DBG][N14][BUILD][RegistrationStatusUpdate] UE-CTX-ID[%s] transfer_status[%d] release_session_count[%ld]",
            ue_context_id, UeRegStatusUpdateReqData.transfer_status,
            UeRegStatusUpdateReqData.to_release_session_list ?
                UeRegStatusUpdateReqData.to_release_session_list->count : 0);
