...
typedef struct nrf_context_s {
    ...
    ogs_list_t disc_cache_list;
} nrf_context_t;

typedef struct nrf_assoc_s nrf_assoc_t;
typedef struct nrf_disc_cache_entry_s nrf_disc_cache_entry_t;
...
typedef struct nrf_assoc_s {
    ...
    char *disc_cache_key;
    int disc_cache_max_age;
} nrf_assoc_t;

typedef struct nrf_disc_cache_entry_s {
    ogs_lnode_t lnode;

    char *key;
    ogs_time_t expires_at;

    int num_nf_instance_id;
    char **nf_instance_id;
} nrf_disc_cache_entry_t;
