        ...
        ogs_sbi_stream_t *stream, ogs_sbi_message_t *recvmsg)
{
    ...
    ogs_info("[DBG][N14][RX][UEContextTransfer-REQ] UE-CTX-ID[%s] UE[%s] reason[%d] access_type[%d]",
            recvmsg->h.resource.component[1],
            amf_ue->supi ? amf_ue->supi : "Unknown",
            recvmsg->UeContextTransferReqData ?
                recvmsg->UeContextTransferReqData->reason : -1,
            recvmsg->UeContextTransferReqData ?
                recvmsg->UeContextTransferReqData->access_type : -1);
    ...
    ogs_info("[DBG][N14][TX][UEContextTransfer-RSP] UE-CTX-ID[%s] UE[%s] mm_ctx_count[%ld] session_ctx_count[%ld] HTTP[%d]",
            recvmsg->h.resource.component[1],
            amf_ue->supi ? amf_ue->supi : "Unknown",
            MmContextList ? MmContextList->count : 0,
            SessionContextList ? SessionContextList->count : 0,
            status);
        ...
        ogs_sbi_message_t *recvmsg, amf_ue_t *amf_ue)
{
    ...
    ogs_info("[DBG][N14][RX][UEContextTransfer-RSP] UE[%s] mm_ctx_count[%ld] session_ctx_count[%ld]",
            UeContext->supi,
            UeContext->mm_context_list ? UeContext->mm_context_list->count : 0,
            UeContext->session_context_list ?
                UeContext->session_context_list->count : 0);
...
int amf_namf_comm_handle_registration_status_update_request(
    ...
    ogs_info("[DBG][N14][RX][RegistrationStatusUpdate-REQ] UE-CTX-ID[%s] UE[%s] transfer_status[%d]",
            recvmsg->h.resource.component[1],
            amf_ue->supi ? amf_ue->supi : "Unknown",
            UeRegStatusUpdateReqData ? UeRegStatusUpdateReqData->transfer_status : -1);
    ...
    */
    ...
    ogs_info("[DBG][N14][TX][RegistrationStatusUpdate-RSP] UE-CTX-ID[%s] UE[%s] reg_status_transfer_complete[%d] HTTP[%d]",
            recvmsg->h.resource.component[1],
            amf_ue ? (amf_ue->supi ? amf_ue->supi : "Unknown") : "Unknown",
            UeRegStatusUpdateRspData.reg_status_transfer_complete,
            status);
