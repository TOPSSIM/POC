...
remote_sudo_helpers() {
    ...
    case "$host" in
        "$HPLMN")
            password="${HPLMN_SUDO_PASSWORD:-}"
            ;;
        "$VPLMN")
            password="${VPLMN_SUDO_PASSWORD:-}"
            ;;
        "$UE")
            password="${UE_SUDO_PASSWORD:-}"
            ;;
        *)
            password=""
            ;;
